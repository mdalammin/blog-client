    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-between text-black">
        <div className="space-y-6">
          <span className="card-title text-lg font-medium block">{title}</span>

          <div className="card-main-content space-y-6">
            <h3 className="text-[15px] md:text-[40px] leading-normal md:leading-[48px] font-semibold tracking-tight">
        ...
        <div className="card-footer-section flex flex-col gap-8">
          <div className="card-metrics flex gap-16">
            <div>
              ...
              <div className="text-black/60 text-sm">Traffic Increase</div>
            </div>

            <div>
              <div className="text-4xl font-semibold">20.8M</div>
              <div className="text-black/60 text-sm">Current Impressions</div>
            </div>
          </div>
      ...
      {/* Right Image */}
      <div className="card-image w-full md:w-[420px] h-full rounded-2xl overflow-hidden shadow-lg bg-white">
        <img
